...
class BTNode {
    ...
    isBalanced() {
        ...
        if (Math.abs(leftHeight - rightHeight) > 1) { //is unbalanced
            console.log("left at top is:  ", leftHeight, " right at top is : ", rightHeight);
            return false ;
        }
        
        if (this.left != null) {
            leftBalance = this.left.isBalanced();
        }
        
        if (this.right != null) {
            rightBalance = this.right.isBalanced();
        }
        
        console.log("left is:  ", leftHeight, " right is : ", rightHeight);
